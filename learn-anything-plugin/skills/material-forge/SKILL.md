...
1. `learning-plan.json` — The curriculum: task classes, sequences, session templates, SRS schedule
2. `knowledge-graph.json` — The skill graph with learner overlay (for difficulty calibration and transfer-leveraged analogies)
...
Save all materials to the project:
